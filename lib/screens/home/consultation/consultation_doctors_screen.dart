                ...
                children: [
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  'О себе: ${doctorData['description'] ?? 'Не указан'}',
                                  style: TextStyle(
                                    fontSize: 16,
                                    fontStyle: FontStyle.italic,
                                    color: Colors.grey[800],
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  'Место работы: ${doctorData['works'] ?? 'Не указан'}',
                                  style: TextStyle(
                                    fontSize: 16,
                                    fontStyle: FontStyle.italic,
                                    color: Colors.grey[800],
                  ...
                  FutureBuilder<QuerySnapshot>(
                    future: FirebaseFirestore.instance
                        .collection('doctors')
                        .doc(doctorData[
                            'doctorId']) // Используем уникальный ID доктора
                            ...
                            children: [
                              ...
                              IconButton(
                                onPressed: () async {
                                  ...
                                  if (picked != null) {
                                    // Обновляем только выбранную запись врача
